...
sigma = 0.0075;					% Ecart-type du noyau gaussien
...
nb_carac = size(X,2);
ind_moins_1 = Y_test==-1;
ind_plus_1 = Y_test==1;
plot3(X_test(ind_moins_1,1),X_test(ind_moins_1,2),(nb_carac+1)*ones(sum(ind_moins_1),1),...
	  'bx','MarkerSize',10,'LineWidth',3);
plot3(X_test(ind_plus_1,1),X_test(ind_plus_1,2),(nb_carac+1)*ones(sum(ind_plus_1),1),...
	  'ro','MarkerSize',10,'LineWidth',3);
%}
