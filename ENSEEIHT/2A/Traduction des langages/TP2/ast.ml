...
type expression =
  ...
  | Null
  | Affectable of affectable (*POur le symbol *)
  | Adresse of string (*pour le symbol &*)
  | New of typ (*def d'un nouveau pointeur*)
...
and instruction =
  ...
  (*BOucle for en +*)
  |Pour of typ * string * string* expression*expression*expression*bloc 
...
(*type affecable après la passe des identifiant, après avoir remplacer les string par des infos*)
type affectable =
  ...
  type expression =
    ...
    | Null | New of typ | Adresse of Tds.info_ast
  ...
  and instruction =
    ...
    |Pour of typ * Tds.info_ast * expression * expression * expression * bloc 
...
type bloc = instruction list
 and instruction =
  ...
  | Empty (* les nœuds ayant disparus: Const *)
  | Pour of Tds.info_ast*expression*expression*expression*bloc
