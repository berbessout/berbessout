function Teb = TEB2(EbN0_db, Nbits, Ns)
Fe = 24000;
Te = 1 / Fe;
Fp = 2000;
rolloff = 0.35;
...
I = sigma_n/sqrt(2) * randn(1, length(x)); % Partie réelle du bruit
Q = sigma_n/sqrt(2) * randn(1, length(x)); % Partie imaginaire du bruit
x = x + I+ 1i*Q;
% Démodulation
x = x.*conj(expo);
